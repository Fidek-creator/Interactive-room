...
var lista_Obiektow, Fridges, Sinks, Corners, Cupboards, Dinig_chairs, Dining_table, Sofas, Dressers, x, aktualnie_wybrany_ID, warto_C5_9B_C4_87, FridgeID, CornersID, SinksID, CupboardsID, Dining_tablesID, Dining_chairsID, SofasID, DressersID;
...
eventHTMLElem('click', 'Kuchnia-Narożnik-0-Kolor blatu-000000', false, function(event) {
  assignMat('naroznik.moj.blat', 'Czarny_top_naroznik');
});
eventHTMLElem('click', 'Kuchnia-Narożnik-0-Kolor frontu-964B00', false, function(event) {
  assignMat('naroznik.moj', 'Drewno.1');
  assignMat('naroznik.moj.dol', 'Drewno.1');
});
eventHTMLElem('click', 'Kuchnia-Narożnik-0-Kolor frontu-C0C0C0', false, function(event) {
  assignMat('naroznik.moj', 'Drewno.2');
  assignMat('naroznik.moj.dol', 'Drewno.2');
});
eventHTMLElem('click', 'Kuchnia-Narożnik-0-Kolor frontu-000000', false, function(event) {
  assignMat('naroznik.moj', 'Drewno.3');
...
eventHTMLElem('click', 'Kuchnia.Narożnik.prev', false, function(event) {
  CornersID = changeFurniture(Corners, CornersID, -1);
});
eventHTMLElem('click', 'Kuchnia.Narożnik.next', false, function(event) {
  CornersID = changeFurniture(Corners, CornersID, 1);
});

eventHTMLElem('click', 'Kuchnia.Zlew.prev', false, function(event) {
  SinksID = changeFurniture(Sinks, SinksID, -1);
});
...
eventHTMLElem('click', 'Kuchnia.Kredensy.prev', false, function(event) {
  CupboardsID = changeFurniture(Cupboards, CupboardsID, -1);
});
eventHTMLElem('click', 'Kuchnia.Kredensy.next', false, function(event) {
  CupboardsID = changeFurniture(Cupboards, CupboardsID, 1);
});

eventHTMLElem('click', 'Kuchnia.Stoły.prev', false, function(event) {
  Dining_tablesID = changeFurniture(Dining_table, Dining_tablesID, -1);
});
eventHTMLElem('click', 'Kuchnia.Stoły.next', false, function(event) {
  Dining_tablesID = changeFurniture(Dining_table, Dining_tablesID, 1);
});

eventHTMLElem('click', 'Kuchnia.Krzesła.prev', false, function(event) {
  Dining_chairsID = changeFurniture(Dinig_chairs, Dining_chairsID, -1);
});
...
eventHTMLElem('click', 'Salon.Sofa.prev', false, function(event) {
  SofasID = changeFurniture(Sofas, SofasID, -1);
});
eventHTMLElem('click', 'Salon.Sofa.next', false, function(event) {
  SofasID = changeFurniture(Sofas, SofasID, 1);
});

eventHTMLElem('click', 'Salon.Komody.prev', false, function(event) {
  DressersID = changeFurniture(Dressers, DressersID, -1);
});
eventHTMLElem('click', 'Salon.Komody.next', false, function(event) {
  DressersID = changeFurniture(Dressers, DressersID, 1);
});
