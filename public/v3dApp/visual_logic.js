...
var Fridges, Corners, Sinks, Cupboards, Dinig_chairs, Dining_table, Sofas, Dressers, sofaMaterials, x, my_Cupboard, my_Corner, my_Sink, my_sofa, FridgeID;
...
Fridges = ['lodowka.1', 'lodowka.2', 'lodowka.3', null];
...
Cupboards = [my_Cupboard, 'kredensy.1'];
...
eventHTMLElem('click', 'Kuchnia-Lodówka-0-Wysokość', false, function(event) {
...
eventHTMLElem('click', 'Kuchnia-Lodówka-0-Kolor-D0D0D0', false, function(event) {
  assignMat('lodowka.moja', 'Czerwona_lodowka');
});
eventHTMLElem('click', 'Kuchnia-Lodówka-0-Kolor-E4A010', false, function(event) {
  assignMat('lodowka.moja', 'Zielona_lodowka.001');
...
my_Cupboard = ['kredens.moj', 'kredens.moj.blat', 'kredens.moj.dol', 'kredens.moj.drzwi', 'kredens.moj.uchwyty'];

my_Corner = ['naroznik.moj', 'naroznik.moj.blat', 'naroznik.moj.dol'];

my_Sink = ['naroznik.moj', 'naroznik.moj.blat', 'naroznik.moj.dol'];

my_sofa = ['sofa.moja', 'poduszki', 'nogi'];
